...
\vspace{-0.5cm}
\input{chapters/02-setup.tex}

\vspace{-0.5cm}
\section*{3. Начало практической работы в Debian}
\addcontentsline{toc}{section}{3. Начало практической работы в Debian}
\vspace{-0.5cm}
\input{chapters/03-packaging-practice.tex}
